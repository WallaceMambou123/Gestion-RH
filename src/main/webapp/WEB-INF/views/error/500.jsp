...
<head>
    <meta charset="UTF-8">
    <title>500 — Erreur Serveur | Gestion RH</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .code { font-size: 6rem; font-weight: 700; color: #f59e0b; line-height: 1; }
...
<body>
    <div class="container">
        ...
        <p class="desc">Une erreur inattendue s'est produite. Veuillez réessayer ou contacter l'administrateur technique.</p>
